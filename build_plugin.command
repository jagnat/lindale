...
# Build hotloaded dll
odin build src/lindale -define:HOT_DLL=false -debug -no-entry-point -build-mode:dynamic -out:out/hot/LindaleHot.dylib
codesign --force --sign - out/hot/LindaleHot.dylib

# Build plugin dll
odin build src -define:HOT_DLL=false -debug -no-entry-point -extra-linker-flags:"-install_name @loader_path/Lindale" -build-mode:dynamic -out:out/Lindale.vst3/Contents/MacOS/Lindale.dylib
